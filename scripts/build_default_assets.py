...
def main():
    ...
    # args.sdkconfig = 'E:/GITPROJECT/houzzkit-ai-v2/sdkconfig'
    # args.builtin_text_font = 'font_puhui_basic_16_4'
    # args.emoji_collection = 'twemoji_64'
    # args.output = 'E:/GITPROJECT/houzzkit-ai-v2/build/assets.bin'
    # args.esp_sr_model_path = 'E:/GITPROJECT/houzzkit-ai-v2/managed_components/espressif__esp-sr/model'
    # args.xiaozhi_fonts_path = 'E:/GITPROJECT/houzzkit-ai-v2/managed_components/78__xiaozhi-fonts'

    # Namespace(
    # sdkconfig='E:/GITPROJECT/houzzkit-ai-v2/sdkconfig',
    # builtin_text_font='font_puhui_basic_16_4', 
    # emoji_collection='twemoji_64', 
    # output='E:/GITPROJECT/houzzkit-ai-v2/build/generated_assets.bin', 
    # esp_sr_model_path='E:/GITPROJECT/houzzkit-ai-v2/managed_components/espressif__esp-sr/model', 
    # xiaozhi_fonts_path='E:/GITPROJECT/houzzkit-ai-v2/managed_components/78__xiaozhi-fonts', 
    # extra_files=None)
    ...
    # 使用Houzzkit表情图标集
    emoji_collection_path = os.path.dirname(os.path.abspath(__file__)) + "/../main/assets/emoji_houzzkit"
    # print(f" emoji_collection_path: {emoji_collection_path}")
