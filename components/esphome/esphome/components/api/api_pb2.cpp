...
template<> const char *proto_enum_to_string<enums::LogLevel>(enums::LogLevel value) {
  switch (value) {
    case enums::API_LOG_LEVEL_NONE:
      return "API_LOG_LEVEL_NONE";
    case enums::API_LOG_LEVEL_ERROR:
      return "API_LOG_LEVEL_ERROR";
    case enums::API_LOG_LEVEL_WARN:
      return "API_LOG_LEVEL_WARN";
    case enums::API_LOG_LEVEL_INFO:
      return "API_LOG_LEVEL_INFO";
    case enums::API_LOG_LEVEL_CONFIG:
      return "API_LOG_LEVEL_CONFIG";
    case enums::API_LOG_LEVEL_DEBUG:
      return "API_LOG_LEVEL_DEBUG";
    case enums::API_LOG_LEVEL_VERBOSE:
      return "API_LOG_LEVEL_VERBOSE";
    case enums::API_LOG_LEVEL_VERY_VERBOSE:
      return "API_LOG_LEVEL_VERY_VERBOSE";
    default:
      return "UNKNOWN";
  }
}
