...
enum LogLevel : uint32_t {
  API_LOG_LEVEL_NONE = 0,
  API_LOG_LEVEL_ERROR = 1,
  API_LOG_LEVEL_WARN = 2,
  API_LOG_LEVEL_INFO = 3,
  API_LOG_LEVEL_CONFIG = 4,
  API_LOG_LEVEL_DEBUG = 5,
  API_LOG_LEVEL_VERBOSE = 6,
  API_LOG_LEVEL_VERY_VERBOSE = 7,
};
