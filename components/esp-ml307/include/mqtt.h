...
public:
    ...
    MqttConnectError LastConnectError() const { return last_connect_error_; }
    const std::string& LastConnectErrorMessage() const { return last_connect_error_message_; }
...
protected:
    void SetLastConnectError(MqttConnectError error, const std::string& message = "") {
        last_connect_error_ = error;
        last_connect_error_message_ = message;
    }

    int keep_alive_seconds_ = 120;
    MqttConnectError last_connect_error_ = MqttConnectError::None;
